...
## 核心功能亮点
1. **JWT无状态认证** - Token过期自动跳转登录
2. **RBAC角色权限** - 管理员/教师/学生三级权限隔离
3. **多维度评分** - 自定义评分标准，按维度独立打分
4. **AI智能分析** - 一键调用豆包大模型分析实验报告，自动给出各维度评分建议和评语
5. **图表可视化诊断** - 雷达图+柱状图直观展示学生能力分布，自动识别薄弱点并给出改进建议
6. **文件上传** - 支持PDF/Word/图片等多格式实验附件
7. **数据统计** - ECharts可视化展示实验数据
8. **分页查询** - MyBatis-Plus分页插件
9. **前后端分离** - Vite代理解决跨域，独立部署
...
| 学生-成绩查询 | 查看老师评分和评语 |
<img width="2887" height="1512" alt="image" src="https://github.com/user-attachments/assets/9e235b44-52b1-430a-ab17-4d29ddde53a3" /><img width="3126" height="1716" alt="image" src="https://github.com/user-attachments/assets/5855d26e-aa47-42c9-ae3f-db43ad141666" /><img width="3183" height="1482" alt="image" src="https://github.com/user-attachments/assets/57e5326c-8b59-4670-9c68-931f265a830e" /><img width="3199" height="1527" alt="image" src="https://github.com/user-attachments/assets/24ccdbae-961c-48ed-aeb1-c913d7d57090" />
